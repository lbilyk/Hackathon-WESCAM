    ...
    with tf.Session(graph=graph) as sess:
        ...
        for i in range(FLAGS.how_many_training_steps):
            ...
            if (i % FLAGS.eval_step_interval) == 0 or is_last_step:
                ...
                print('Epoch: %d, Train accuracy: %.4f%%, Loss: %f, Validation accuracy: %.1f%% (N=%d)' % (i,
...
if __name__ == '__main__':
    ...
    parser.add_argument(
        '--output_graph',
        type=str,
        default='./Output_Graph/output_graph.pb',
        help='Where to save the trained graph.'
        )
    parser.add_argument(
        '--output_labels',
        type=str,
        default='./Output_Labels/output_labels.txt',
        help='Where to save the trained graph\'s labels.'
        )
    parser.add_argument(
        '--summaries_dir',
        type=str,
        default='./Summaries_dir/retrain_logs',
    ...
    parser.add_argument(
        ...
        A value of -1 causes the entire test set to be used,q which leads to more
